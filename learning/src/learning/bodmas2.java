...
public class bodmas2 {
    ...
    {
        bodmas2 var1= new bodmas2();
        int output1=var1.plus(10,2);
        int output2=var1.plus(output1,2);
        int output3= var1.minus(output2,2);
        int output4=var1.multiply(output3,2);
        var1.divide(output4,2);
    }
}
